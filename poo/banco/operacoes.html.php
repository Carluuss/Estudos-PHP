...
<div class='card container mt-3 mb-3'>
    ...
    class='mt-1'>OPERAÇÕES BANCARIA</h2>
</div>
...
<div id= 'alertaConta' class='form-text'>
</div>
...
<input type='text' class='form-control' id='valor' name='valor' value='' onblur='V_valor(this)' required>
<div id= 'alertaValor' class='form-text'>
</div>
